...
def add_cafe():
    ...
    if form.validate_on_submit():
        ...
        with open('cafe-data.csv', newline='', encoding='utf8', mode='a') as csv_file:
            ...
            csv_writer.writerow([form.cafe.data, form.cafe_location.data, form.opening_time.data,
                                 form.closing_time.data, form.coffee_rating.data, form.wifi_strength_rating.data,
