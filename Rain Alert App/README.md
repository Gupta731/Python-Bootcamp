This program notifies the user about possible rain in the next 12 hours by sending an SMS early morning when the user is supposed to be leaving for work.
